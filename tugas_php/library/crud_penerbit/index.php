...
<body>
    ...
    $penerbits = mysqli_query($conn, $query);
    ...
    <div class="container mt-5">
        <div class="row" style="margin: 50px;">
            ...
            <div class="col-3 text-center">
                <h5><a href="index.php " class="nav-link btn btn bg-primary text-white">Tugas CRUD Penerbit</a></h5>
            </div>
            <div class="col-3 text-center">
        ...
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary mb-5" href="create.php">Add Data Penerbit</a>
            </div>
            <div class="col-md-12">
